...
commander.version(require('../package.json').version).usage('[options] [project name]').parse(process.argv);
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            logMessage("\u51C6\u5907\u8FDB\u5165 ".concat(serviceDirectoryName, " \u6587\u4EF6\u5939"));
            _context.next = 3;
          ...
          case 3:
            ...
            // 如果没有就创建一个
            logMessage("\u672A\u53D1\u73B0 ".concat(serviceDirectoryName, " \u6587\u4EF6\u5939\uFF0C\u5F00\u59CB\u521B\u5EFA"), colors.red); // await execPromise(`mkdir ${serviceDirectoryName}`);

            _context.next = 8;
            return execPromise("git clone https://github.com/aisriver/code-act-service.git ".concat(serviceDirectoryName));
          ...
          case 12:
            logMessage("\u521B\u5EFA ".concat(serviceDirectoryName, " \u6210\u529F!"), colors.green);
            cdServiceDirectory();
            return _context.abrupt("return");

          case 15:
            logMessage("\u8FDB\u5165 ".concat(serviceDirectoryName, " \u6210\u529F!"), colors.green);
            startService();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            logMessage("\u5B89\u88C5\u4F9D\u8D56\u9047\u5230\u4E9B\u95EE\u9898\uFF1A".concat(installResult.error), colors.red);
